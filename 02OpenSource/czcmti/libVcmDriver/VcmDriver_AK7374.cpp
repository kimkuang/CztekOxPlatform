...
VcmDriver_AK7374::VcmDriver_AK7374(uint i2cAddr) :
    VcmDriver(i2cAddr)
{
}
...
int VcmDriver_AK7374::VcmReadCode(uint &value)
{
    (void)value;
	//USHORT ecode=0;
	//USHORT Msb =0;
...
int VcmDriver_AK7374::VcmWriteCode(uint value)
{
    if (value >= 1023)
    {
        value = 1023;
