...
EEPROM_GT24P64A::EEPROM_GT24P64A(uint i2cAddr)
...
EEPROM_GT24P64A::~EEPROM_GT24P64A(void)
{

}

int EEPROM_GT24P64A::OtpRead(uint startAddr, uint endAddr, uchar *buf, ushort page)
{
    return EEPROM_Normal::OtpRead(startAddr, endAddr, buf, page);
}

int EEPROM_GT24P64A::OtpWrite(uint startAddr, uint endAddr, const uchar *buf, ushort page)
{
    uchar ubTmp = 0x00;
#if 1
    /**
