...
int ConfWidget::Cache2Ui()
{
    ...
    ui->m_spinLowerLimit_DVDD->setValue(m_option->DvddLowerLimit);
    ui->m_spinLowerLimit_AVDD->setValue(m_option->AvddLowerLimit);
    ui->m_spinLowerLimit_DOVDD->setValue(m_option->DovddLowerLimit);
    ui->m_spinLowerLimit_AFVCC->setValue(m_option->AfvccLowerLimit);
    ui->m_spinLowerLimit_VPP->setValue(m_option->VppLowerLimit);
    ui->m_spinLowerLimit_Total->setValue(m_option->TotalLowerLimit);
...
int ConfWidget::Ui2Cache()
{
    ...
    m_option->DvddLowerLimit = ui->m_spinLowerLimit_DVDD->value();
    m_option->AvddLowerLimit = ui->m_spinLowerLimit_AVDD->value();
    m_option->DovddLowerLimit = ui->m_spinLowerLimit_DOVDD->value();
    m_option->AfvccLowerLimit = ui->m_spinLowerLimit_AFVCC->value();
    m_option->VppLowerLimit = ui->m_spinLowerLimit_VPP->value();
    m_option->TotalLowerLimit = ui->m_spinLowerLimit_Total->value();
